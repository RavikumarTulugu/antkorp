...
function noty(options) {
	...
	if(options.closable == undefined){
		options.closable = jQuery.noty.defaults.closable;
	}
		...
		style: function() {
			...
			switch (this.options.type) {
				case 'alert': case 'notification':
					this.$bar.css({backgroundColor: 'rgba(52,73,94,.7)', borderColor: '#2C3E50', color: '#FFF'}); break;
				case 'warning':
					this.$bar.css({backgroundColor: 'rgba(26,188,156,.7)', borderColor: '#F39C12', color: '#fff'}); 
					this.$buttons.css({borderTop: '1px solid #F39C12'}); break;
				case 'error':
					this.$bar.css({backgroundColor: 'rgba(231,76,60,.7)', borderColor: '#C0392B', color: '#FFF'});
					this.$message.css({fontWeight: 'bold'}); 
					this.$buttons.css({borderTop: '1px solid #C0392B'}); break;
				case 'information':
					this.$bar.css({backgroundColor: 'rgba(52,152,219,.7)', borderColor: '#2980B9', color: '#FFF'}); 
					this.$buttons.css({borderTop: '1px solid #2980B9'}); break;
				case 'success':
					this.$bar.css({backgroundColor: 'rgba(46,204,113,.7)', borderColor: '#27AE60', color: '#fff'}); 
					this.$buttons.css({borderTop: '1px solid #27AE60'});break;
				default:
					this.$bar.css({backgroundColor: 'rgba(255,255,255,.7)', borderColor: '#CCC', color: '#444'}); break;
			}
		},
		callback: {
