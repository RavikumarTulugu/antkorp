...
/**
 * @fileOverview calendar functionality
 * @name calendar
 */
...
define(
		...
		[ "jquery", "underscore", "backbone", "akpauth", "akpcontacts",
				"akputils",	"jqueryui", //"plugins/gettheme", "plugins/jqxcore","plugins/jqxwindow",
			...
			var MasterView = Backbone.View
					.extend({
						...
						initialize : function() {
							...
							this.collection.bind("eventremove",									this.removeEvent, this);
							this.collection.bind("refresh", this.refresh, this);
							this.collection.bind("notification",									this.addNotification, this);
							this.collection.bind("showEvent",									this.showEventById, this);
							this.collection.bind("addRequest",									this.addInvitation, this);
							this.collection.bind("alert", this.alertEvent, this);
							this.collection.bind("clear", this.clearCalendar,			this);
						...
						handleInvitations:function(){
							var invt_opts = {
								...
								this.invitations = auth.invitationsDialog(invt_opts);
						},	
						...
						show : function() {
							...
							this.calendar = $('.cal_view')									.fullCalendar(
											{
												editable : true,
												theme : false,
												header : {
						...
						handleViewChange : function(view) {
							...
							this.collection.getEvents(view.visStart,view.visEnd);
			...
			var showEventView = Backbone.View
					.extend({
						...
						renderEvent : function(obj) {
							...
							if (obj.attachments)
								obj.hasAttachments = obj.attachments.length ;
			...
			var createEventView = Backbone.View	.extend({
						...
						initialize : function() {
							_.bindAll(this, "renderMax", "hideAccessOpts",
									"setUsers", "saveEvent","showAttachments");
						...
						events : {
							...
							'submit .newEventForm' : 'preventDefault'
						...
						renderMax : function(obj) {
							...
							var template = $("#newEvent-template")									.tmpl([ obj ]);
						...
						showAttachments : function() {
							var $attachEl = this.$(".evt-attachments");
							$attachEl.show();
						},
						showMax : function() {
							$(".cal_view").hide("slide", {
