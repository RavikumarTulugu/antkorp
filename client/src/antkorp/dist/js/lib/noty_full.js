		...
		style: function() {
			...
			switch (this.options.type) {
				case 'alert': case 'notification':
					this.$bar.css({backgroundColor: '#34495E', borderColor: '#2C3E50', color: '#FFF'}); break;
				case 'warning':
					this.$bar.css({backgroundColor: '#1ABC9C', borderColor: '#F39C12', color: '#fff'}); 
					this.$buttons.css({borderTop: '1px solid #F39C12'}); break;
				case 'error':
					this.$bar.css({backgroundColor: '#E74C3C', borderColor: '#C0392B', color: '#FFF'});
					this.$message.css({fontWeight: 'bold'}); 
					this.$buttons.css({borderTop: '1px solid #C0392B'}); break;
				case 'information':
					this.$bar.css({backgroundColor: '#3498DB', borderColor: '#2980B9', color: '#FFF'}); 
