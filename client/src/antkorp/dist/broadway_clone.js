...
//rewriting connect call

var initialized=false;

function connect(){
	 var supports_binary  = true;
	window.addEventListener("message", function(e){
		handleMessage(THREE.Base64.toArrayBuffer(e.data));
		if(!initialized){
			start();
			initialized=true;
		}
	}, false);
	inputSocket=new sendFunc;
	
}
//rewriting send callback
var sendFunc=function(){
	
}
sendFunc.prototype.send=function(msg){
var obj={
		mesgtype:"gtk_viewer",
		originalMsg:msg,
}
	parent.postMessage(obj,window.location.origin);
}
