...
ZIP=/tmp/gtk+-3.12.1.zip
DEVZIP=/tmp/gtk+-dev-3.12.1.zip
...
mkdir -p share/doc/gtk+-3.12.1
cp -p /home/rk/Downloads/gtk+-3.12.1/COPYING share/doc/gtk+-3.12.1

mkdir -p share/doc/gtk+-dev-3.12.1
cp -p /home/rk/Downloads/gtk+-3.12.1/COPYING share/doc/gtk+-dev-3.12.1
...
zip -r -D $ZIP share/doc/gtk+-3.12.1
...
zip -r $DEVZIP share/doc/gtk+-dev-3.12.1
