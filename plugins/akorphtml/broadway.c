...
extern writeToGwSvr(char *buf, size_t size);
extern int getGwConnId(void);
...
BroadwayOutput *
broadway_output_new(unsigned int serial, int sock)
{
  BroadwayOutput *output = (BroadwayOutput*)malloc(sizeof(BroadwayOutput));
